...
import HeroSectionFive from '@/components/blocks/hero-section/hero-section-five'
...
export const blockRegistryEntries: BlockRegistryEntry[] = [
  entry(
    defineBlock({
      ...
      cli: 'bunx --bun shadcn add @blocks/footer-section-one',
    }),
    FooterSectionOne,
  ),
  entry(
    defineBlock({
      ...
      cli: 'bunx --bun shadcn add @blocks/footer-section-two',
    }),
    FooterSectionTwo,
  ),
  entry(
    defineBlock({
      ...
      cli: 'bunx --bun shadcn add @blocks/forgot-password-one',
    }),
    ForgotPasswordOne,
  ),
  entry(
    defineBlock({
      ...
      cli: 'bunx --bun shadcn add @blocks/forgot-password-three',
    }),
    ForgotPasswordThree,
  ),
  entry(
    defineBlock({
      ...
      cli: 'bunx --bun shadcn add @blocks/forgot-password-two',
    }),
    ForgotPasswordTwo,
  ),
  entry(
    defineBlock({
      ...
      cli: 'bunx --bun shadcn add @blocks/header-one',
    }),
    HeaderOne,
  ),
  entry(
    defineBlock({
      ...
      cli: 'bunx --bun shadcn add @blocks/header-two',
    }),
    HeaderTwo,
  ),
  entry(
    defineBlock({
      slug: 'hero-section-five',
      title: 'Hero Section Five',
      description: '',
      category: 'hero',
      tags: ['hero-section', 'hero'],
      sourceFiles: [{ path: 'components/blocks/hero-section/hero-section-five.tsx', language: 'tsx' }],
      cli: 'bunx --bun shadcn add @blocks/hero-section-five',
    }),
    HeroSectionFive,
  ),
  entry(
    defineBlock({
      ...
      cli: 'bunx --bun shadcn add @blocks/hero-section-four',
    }),
    HeroSectionFour,
  ),
  entry(
    defineBlock({
      ...
      cli: 'bunx --bun shadcn add @blocks/hero-section-one',
    }),
    HeroSectionOne,
  ),
  entry(
    defineBlock({
      ...
      cli: 'bunx --bun shadcn add @blocks/hero-section-three',
    }),
    HeroSectionThree,
  ),
  entry(
    defineBlock({
      ...
      cli: 'bunx --bun shadcn add @blocks/hero-section-two',
    }),
    HeroSectionTwo,
  ),
  entry(
    defineBlock({
      ...
      cli: 'bunx --bun shadcn add @blocks/logo-cloud-one',
    }),
    LogoCloudOne,
  ),
  entry(
    defineBlock({
      ...
      cli: 'bunx --bun shadcn add @blocks/logo-cloud-three',
    }),
    LogoCloudThree,
  ),
  entry(
    defineBlock({
      ...
      cli: 'bunx --bun shadcn add @blocks/logo-cloud-two',
    }),
    LogoCloudTwo,
  ),
  entry(
    defineBlock({
      ...
      cli: 'bunx --bun shadcn add @blocks/sign-up-one',
    }),
    SignUpOne,
  ),
  entry(
    defineBlock({
      ...
      cli: 'bunx --bun shadcn add @blocks/sign-up-two',
    }),
    SignUpTwo,
  ),
  entry(
    defineBlock({
      ...
      cli: 'bunx --bun shadcn add @blocks/teams-section-five',
    }),
    TeamsSectionFive,
  ),
  entry(
    defineBlock({
      ...
      cli: 'bunx --bun shadcn add @blocks/teams-section-four',
    }),
    TeamsSectionFour,
  ),
  entry(
    defineBlock({
      ...
      cli: 'bunx --bun shadcn add @blocks/teams-section-one',
    }),
    TeamsSectionOne,
  ),
  entry(
    defineBlock({
      ...
      cli: 'bunx --bun shadcn add @blocks/teams-section-three',
    }),
    TeamsSectionThree,
  ),
  entry(
    defineBlock({
      ...
      cli: 'bunx --bun shadcn add @blocks/teams-section-two',
    }),
    TeamsSectionTwo,
  ),
  entry(
    defineBlock({
      ...
      cli: 'bunx --bun shadcn add @blocks/testamonial-section-one',
    }),
