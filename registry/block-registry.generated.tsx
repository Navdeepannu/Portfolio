...
export const blockRegistryEntries: BlockRegistryEntry[] = [
  entry(
    defineBlock({
      ...
      cli: 'bunx --bun shadcn@latest add @nav/footer-section-one',
    }),
    FooterSectionOne,
  ),
  entry(
    defineBlock({
      ...
      cli: 'bunx --bun shadcn@latest add @nav/footer-section-two',
    }),
    FooterSectionTwo,
  ),
  entry(
    defineBlock({
      ...
      cli: 'bunx --bun shadcn@latest add @nav/forgot-password-one',
    }),
    ForgotPasswordOne,
  ),
  entry(
    defineBlock({
      ...
      cli: 'bunx --bun shadcn@latest add @nav/forgot-password-three',
    }),
    ForgotPasswordThree,
  ),
  entry(
    defineBlock({
      ...
      cli: 'bunx --bun shadcn@latest add @nav/forgot-password-two',
    }),
    ForgotPasswordTwo,
  ),
  entry(
    defineBlock({
      ...
      cli: 'bunx --bun shadcn@latest add @nav/header-one',
    }),
    HeaderOne,
  ),
  entry(
    defineBlock({
      ...
      cli: 'bunx --bun shadcn@latest add @nav/header-two',
    }),
    HeaderTwo,
  ),
  entry(
    defineBlock({
      ...
      cli: 'bunx --bun shadcn@latest add @nav/hero-section-four',
    }),
    HeroSectionFour,
  ),
  entry(
    defineBlock({
      ...
      cli: 'bunx --bun shadcn@latest add @nav/hero-section-one',
    }),
    HeroSectionOne,
  ),
  entry(
    defineBlock({
      ...
      cli: 'bunx --bun shadcn@latest add @nav/hero-section-three',
    }),
    HeroSectionThree,
  ),
  entry(
    defineBlock({
      ...
      cli: 'bunx --bun shadcn@latest add @nav/hero-section-two',
    }),
    HeroSectionTwo,
  ),
  entry(
    defineBlock({
      ...
      cli: 'bunx --bun shadcn@latest add @nav/logo-cloud-one',
    }),
    LogoCloudOne,
  ),
  entry(
    defineBlock({
      ...
      cli: 'bunx --bun shadcn@latest add @nav/logo-cloud-three',
    }),
    LogoCloudThree,
  ),
  entry(
    defineBlock({
      ...
      cli: 'bunx --bun shadcn@latest add @nav/logo-cloud-two',
    }),
    LogoCloudTwo,
  ),
  entry(
    defineBlock({
      ...
      cli: 'bunx --bun shadcn@latest add @nav/sign-up-one',
    }),
    SignUpOne,
  ),
  entry(
    defineBlock({
      ...
      cli: 'bunx --bun shadcn@latest add @nav/sign-up-two',
    }),
    SignUpTwo,
  ),
  entry(
    defineBlock({
      ...
      cli: 'bunx --bun shadcn@latest add @nav/teams-section-five',
    }),
    TeamsSectionFive,
  ),
  entry(
    defineBlock({
      ...
      cli: 'bunx --bun shadcn@latest add @nav/teams-section-four',
    }),
    TeamsSectionFour,
  ),
  entry(
    defineBlock({
      ...
      cli: 'bunx --bun shadcn@latest add @nav/teams-section-one',
    }),
    TeamsSectionOne,
  ),
  entry(
    defineBlock({
      ...
      cli: 'bunx --bun shadcn@latest add @nav/teams-section-three',
    }),
    TeamsSectionThree,
  ),
  entry(
    defineBlock({
      ...
      cli: 'bunx --bun shadcn@latest add @nav/teams-section-two',
    }),
    TeamsSectionTwo,
  ),
  entry(
    defineBlock({
      ...
      cli: 'bunx --bun shadcn@latest add @nav/testamonial-section-one',
    }),
