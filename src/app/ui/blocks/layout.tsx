...
import BlocksCategoryNav from '@/features/navui/catalog/blocks/blocks-category-nav'
...
export default function Layout({ children }: { children: ReactNode }) {
  return (
    <main className="bg-background selection:bg-emerald-200/60 dark:[--background:#101010] dark:selection:bg-emerald-500 dark:selection:text-white">
