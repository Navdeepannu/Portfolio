...
export function PortfolioPage() {
  return (
    <div className="landing-page min-h-screen overflow-x-clip bg-background font-schibsted text-foreground selection:bg-emerald-200/70 dark:[--background:#101010] dark:selection:bg-emerald-500 dark:selection:text-white">
      <LandingHeader />
