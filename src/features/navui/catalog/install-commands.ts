 ...
 * `<base>` is the canonical UI-library origin from `src/config/site-origins.ts`. Changing it
 ...
 *
 *    The build step (`scripts/registry/finalize-registry.ts`) rewrites internal
