 ...
 * `@/features/navui/catalog/install-commands`. Several showcase components import package-manager types and
 * install commands from here; the actual registry URL logic lives in one place
 * (`@/features/navui/catalog/install-commands`) so the production domain only needs to change there.
 */
export {
