import { componentDefinitions as components } from '@/features/navui/catalog/components/component-entries'

import { componentCategories, DEFAULT_COMPONENT_CATEGORY_ID } from './component-categories'
import type { ComponentCategory, ComponentCategoryId, ComponentDefinition } from '@/registry/types'
