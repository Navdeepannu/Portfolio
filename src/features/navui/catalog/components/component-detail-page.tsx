...
} from '@/features/navui/catalog'
import ComponentRenderer from '@/features/navui/catalog/components/component-renderer'
import ComponentDocSidebar from '@/features/navui/catalog/components/component-doc-sidebar'
  ...
  return (
    <div className="mx-auto flex w-full gap-8 px-4 py-8 md:px-6 lg:gap-16">
      <aside className="sticky top-20 hidden h-fit shrink-0 self-start lg:block">
        <ComponentDocSidebar items={sidebarItems} activeSlug={component.slug} className="static" />
      </aside>
