import { componentDefinitions } from '@/features/navui/catalog/components/component-entries'

import type { ComponentCategory, ComponentCategoryId } from '@/registry/types'
