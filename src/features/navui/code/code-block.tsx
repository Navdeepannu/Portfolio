...
export const CodeBlock = ({
  ...
  return (
    <CodeBlockContext.Provider value={{ value, onValueChange, data }}>
      <div
        className={cn('size-full overflow-hidden rounded-md border border-ring/10', className)}
        {...props}
      />
...
export const CodeBlockHeader = ({ className, ...props }: CodeBlockHeaderProps) => (
  <div className={cn('flex flex-row items-center bg-secondary p-1', className)} {...props} />
)
...
export const CodeBlockCopyButton = ({
  ...
  return (
    <Button
      className={cn('ph-no-capture shrink-0', className)}
      onClick={() => void copyToClipboard()}
      size="icon"
      variant="ghost"
      {...props}
