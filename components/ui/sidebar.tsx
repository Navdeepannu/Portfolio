    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          data-slot="sidebar"
          data-mobile="true"
          className="inset-y-auto! top-12! bottom-0! h-[calc(100dvh-3rem)]! max-h-[calc(100dvh-3rem)]! w-(--sidebar-width) bg-background p-0 text-foreground data-[side=left]:h-[calc(100dvh-3rem)]! [&>button]:hidden"
          style={
            {
  ...
  if (asChild) {
    return (
      <Slot.Root
        ...
        onClick={handleClick as React.ComponentProps<typeof Slot.Root>['onClick']}
        className={className}
        {...props}
      >
        {children}
