...
const metrics = [
  ...
  { value: 125000, prefix: '$', duration: 1.4, label: 'Revenue influenced' },
]

export default function AnimatedNumbersShowcase() {
  return (
    <dl className="grid w-full max-w-3xl grid-cols-2 gap-px overflow-hidden rounded-xl border bg-border sm:grid-cols-4">
