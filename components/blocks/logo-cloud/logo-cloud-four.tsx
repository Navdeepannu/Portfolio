...
const companies: Company[] = [
  {
    ...
    icon: (
      ...
      >
        ...
        <path
          className="st0"
          d="M139.03,4.61h90.64v49.93h-87.57c-47.24,0-84.11,27.27-84.11,84.88s36.87,84.88,84.11,84.88h87.57v49.93h-94.48c-79.12,0-135.19-46.48-135.19-134.82S59.91,4.61,139.03,4.61Z"
        />
        <path
          className="st0"
          d="M275.75,4.61h56.07v164.76c0,41.09,18.82,60.3,62.99,60.3s62.99-19.2,62.99-60.3V4.61h56.07v176.28c0,59.91-38.02,97.94-119.06,97.94s-119.06-38.41-119.06-98.32V4.61Z"
        />
        <path
          className="st0"
          d="M806.9,81.04c0,29.96-17.28,53-40.33,62.99v.77c24.2,3.46,36.49,20.74,36.87,44.17l1.15,85.26h-56.07l-1.15-76.04c-.38-16.9-10.37-27.27-30.34-27.27h-93.33v103.31h-56.07V4.61h154.78c50.7,0,84.49,25.73,84.49,76.43h0ZM750.45,88.72c0-23.04-12.29-35.72-35.33-35.72h-91.41v71.43h92.17c21.12,0,34.57-12.67,34.57-35.72h0Z"
        />
        <path
          className="st0"
          d="M1018.9,195.49c0-19.2-12.29-27.27-30.72-28.8l-62.22-5.76c-53.77-4.99-81.81-26.12-81.81-77.2S878.72,4.61,928.26,4.61h137.49v48.39h-133.65c-19.2,0-31.49,9.99-31.49,29.19s12.67,28.42,31.88,29.96l63.37,5.38c48.01,4.22,79.5,26.12,79.5,77.58s-33.41,79.12-80.65,79.12h-143.64v-48.39h138.26c18.05,0,29.57-12.29,29.57-30.34h0Z"
        />
        <path
          className="st0"
          d="M1239.35,0c84.49,0,137.88,54.15,137.88,139.03s-55.69,139.8-140.18,139.8-137.88-54.92-137.88-139.8S1154.86,0,1239.35,0ZM1319.24,139.41c0-56.84-33.03-90.25-81.04-90.25s-81.04,33.41-81.04,90.25,33.03,90.25,81.04,90.25,81.04-33.41,81.04-90.25Z"
        />
        <path
          className="st0"
          d="M1655.29,81.04c0,29.96-17.28,53-40.33,62.99v.77c24.2,3.46,36.49,20.74,36.87,44.17l1.15,85.26h-56.07l-1.15-76.04c-.38-16.9-10.37-27.27-30.34-27.27h-93.33v103.31h-56.07V4.61h154.78c50.7,0,84.49,25.73,84.49,76.43h0ZM1598.83,88.72c0-23.04-12.29-35.72-35.33-35.72h-91.41v71.43h92.17c21.12,0,34.57-12.67,34.57-35.72h0Z"
        />
      </svg>
    ),
  },
  {
    name: 'Better Auth',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 400 51.657">
        <path
      ...
      >
        <g>
          <g>
            ...
            <path
              id="h_5_"
              d="M208.6,48.4c-6.7,0-11.9,3.2-16,8l-0.2-0.1l5.8-30.4H183l-14.7,77.3h15.1l5-26.4c2-10,7.1-16.1,11.9-16.1    c3.4,0,4.7,2.3,4.7,5.6c0,2.1-0.2,4.6-0.7,6.7l-5.7,30.3h15.1l5.9-31.2c0.7-3.3,1.1-7.2,1.1-9.9C220.9,53.5,216.5,48.4,208.6,48.4    z"
            />
            <path
              id="o_5_"
              d="M255.1,48.4c-18.2,0-30.3,16.4-30.3,34.7c0,11.7,7.2,21.2,20.8,21.2c17.9,0,29.9-16,29.9-34.7    C275.6,58.7,269.3,48.4,255.1,48.4z M247.7,92.6c-5.2,0-7.3-4.4-7.3-9.9c0-8.7,4.5-22.8,12.7-22.8c5.4,0,7.1,4.6,7.1,9.1    C260.2,78.4,255.7,92.6,247.7,92.6z"
            />
            <path
              id="p_5_"
            ...
            <path
              id="y_5_"
              d="M430.6,49.6c0,0-9.5,23.8-13.7,36.8h-0.2c-0.3-4.2-3.7-36.8-3.7-36.8h-15.9l9.1,49.2c0.2,1.1,0.1,1.8-0.3,2.5    c-1.8,3.4-4.7,6.7-8.2,9.1c-2.8,2.1-6,3.4-8.5,4.3l4.2,12.8c3.1-0.7,9.4-3.2,14.8-8.2c6.9-6.5,13.3-16.4,19.8-30l18.5-39.7H430.6z    "
            />
          </g>
          <g>
      ...
      <div className="mx-auto w-full max-w-6xl px-6">
        <div className="mx-auto mb-12 max-w-2xl text-center">
          <h2 className="text-3xl font-semibold tracking-tight text-balance text-zinc-950 sm:text-4xl dark:text-white">
            Built with the tools teams already trust
          </h2>

          <p className="mt-3 text-sm leading-6 text-balance text-zinc-600 sm:text-base dark:text-zinc-400">
            From design and code to auth, deployment, and AI, these are the platforms behind
...
function LogoCell({
  ...
  const smoothOpacity = useSpring(glowOpacity, springConfig)

  const blinkDuration = randomBetween(index, 5.5, 10, 1)
  const blinkDelay = randomBetween(index, 0, 3.8, 2)

  const softCardGlow = useMotionTemplate`
  radial-gradient(
    220px circle at ${smoothX}px ${smoothY}px,
    rgb(var(--glow-card) / 0.10),
    rgb(var(--glow-card) / 0.04) 34%,
    transparent 70%
  )
`
  ...
  radial-gradient(
    ...
    rgb(var(--glow-border) / 0.9),
    rgb(var(--glow-border) / 0.45) 38%,
    transparent 72%
  )
`
  ...
  return (
    <div
      ...
      className="group/cell relative flex min-h-32 items-center justify-center overflow-visible px-8 py-10 [--glow-border:190_242_100] [--glow-card:163_230_53]"
    >
      ...
      {/* stronger cursor border glow */}
      <motion.div
        aria-hidden="true"
        className="pointer-events-none absolute inset-0 z-20 rounded-none p-px"
        style={{
...
function FadedCellLines() {
  return (
    <div aria-hidden="true" className="pointer-events-none absolute inset-0 z-10">
      <span className="absolute top-0 left-0 h-px w-full bg-linear-to-r from-transparent via-zinc-300/75 to-transparent transition duration-300 group-hover/cell:via-lime-300/95 group-hover/cell:shadow-[0_0_18px_rgb(190_242_100/0.85)] dark:via-white/15" />
      <span className="absolute bottom-0 left-0 h-px w-full bg-linear-to-r from-transparent via-zinc-300/75 to-transparent transition duration-300 group-hover/cell:via-lime-300/95 group-hover/cell:shadow-[0_0_18px_rgb(190_242_100/0.85)] dark:via-white/15" />
      <span className="absolute top-0 left-0 h-full w-px bg-linear-to-b from-transparent via-zinc-300/75 to-transparent transition duration-300 group-hover/cell:via-lime-300/95 group-hover/cell:shadow-[0_0_18px_rgb(190_242_100/0.85)] dark:via-white/15" />
      <span className="absolute top-0 right-0 h-full w-px bg-linear-to-b from-transparent via-zinc-300/75 to-transparent transition duration-300 group-hover/cell:via-lime-300/95 group-hover/cell:shadow-[0_0_18px_rgb(190_242_100/0.85)] dark:via-white/15" />
    </div>
  )
}
...
function CornerDots({ index, shouldReduceMotion }: { index: number; shouldReduceMotion: boolean }) {
  ...
  const dots = ['left-0 top-0', 'right-0 top-0', 'bottom-0 left-0', 'bottom-0 right-0']
    ...
    <>
      {dots.map((position, dotIndex) => (
        <motion.span
          ...
          aria-hidden="true"
          className={cn(
            'pointer-events-none absolute z-30 size-1 rounded-full bg-zinc-400/70 transition duration-300 group-hover/cell:bg-lime-300 group-hover/cell:shadow-[0_0_14px_rgb(190_242_100/0.95)] dark:bg-white/35',
